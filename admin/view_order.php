  ...
  <div class="container">
    ...
    <div class="card border-0 shadow-lg rounded-4 overflow-hidden" data-aos="zoom-in" data-aos-duration="1000">
      ...
      <div class="card-body p-4">
          ...
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
            ...
            <form action="update_order.php" method="POST">
              ...
              <select name="order_status" class="form-select" onchange="this.form.submit()">
                <option value="Completed" <?php echo $order['order_Status'] == "Completed" ? "selected" : ""; ?>>Completed
                </option>
                <option value="Pending" <?php echo $order['order_Status'] == "Pending" ? "selected" : ""; ?>>Pending
                </option>
                <option value="Cancelled" <?php echo $order['order_Status'] == "Cancelled" ? "selected" : ""; ?>>Cancelled
                </option>
              </select>
            </form>
            ...
            <p class="mb-3"><i class="bi bi-cash-stack text-info"></i> <strong>Total Amount:</strong>
        ...
        <!-- Back to Dashboard Button (INSIDE CARD) -->
        <div class="d-flex justify-content-center mt-4" data-aos="fade-up" data-aos-delay="1200">
          <a href="dashboard.php" class="btn btn-primary btn-lg shadow-sm rounded-pill px-4 py-2">
