            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm h-100">
                        <img src="../uploads/<?php echo htmlspecialchars($row['image_path']); ?>" class="card-img-top"
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            ...
                            <button class="btn btn-sm btn-danger"
                                onclick="deleteProduct(<?php echo $row['product_id']; ?>)">Delete</button>
                        </div>
                    </div>
                </div>
                <?php
                    ...
                    <div class="card shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-1">Category: <span
                                    class="fw-bold"><?php echo htmlspecialchars($row['category_name']); ?></span></p>
                            <p class="mb-1">Price: <span class="fw-bold">$<?php echo htmlspecialchars($row['price']); ?></span></p>
                            <p class="mb-2">Stock: <?php echo htmlspecialchars($row['stock_quamtitiy']); ?></p>
