          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 shadow-sm position-relative overflow-hidden">
              ...
              <div class="position-relative overflow-hidden">
                <img src="uploads/<?php echo htmlspecialchars($product['image_path']); ?>" class="card-img-top img-fluid"
              ...
              <div class="card-body d-flex flex-column">
                ...
                if (isset($_SESSION['user'])) {
                  ...
                  <button class="btn btn-primary mt-auto"
                    href="single_product.php?productid=<?php echo $product['product_id']; ?>">
                    Add to Cart
                  </button>
